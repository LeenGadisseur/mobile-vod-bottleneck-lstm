#!/usr/bin/python3
"""
Evalueren gegeven netwerk van de klasse SSD op het test gedeelte van de EPFL dataset.
"""
import cv2
import torch
import argparse
...
#device = torch.device("cuda:0" if torch.cuda.is_available() and args.use_cuda else "cpu")#Cuda heeft te weinig geheugen
...
if __name__=='__main__':
	...
	class_names = dataset._classes_names
